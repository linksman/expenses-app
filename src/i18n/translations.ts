...
export const TRANSLATIONS: Record<LanguageCode, Translations> = {
  en: {
    ...
    manage: {
      ...
      emptySubtitle: "Tap \"Add Expense\" below to log your first one.",
      delete: 'Delete',
  ...
  fr: {
    ...
    manage: {
      ...
      emptySubtitle: 'Appuyez sur « Ajouter une dépense » ci-dessous pour enregistrer la première.',
      delete: 'Supprimer',
  ...
  de: {
    ...
    manage: {
      ...
      emptySubtitle: 'Tippe unten auf „Ausgabe hinzufügen“, um die erste einzutragen.',
      delete: 'Löschen',
  ...
  es: {
    ...
    manage: {
      ...
      emptySubtitle: 'Toca "Añadir gasto" abajo para registrar el primero.',
      delete: 'Eliminar',
  ...
  he: {
    ...
    manage: {
      ...
      emptySubtitle: 'הקישו על "הוספת הוצאה" למטה כדי לרשום את הראשונה.',
      delete: 'מחיקה',
